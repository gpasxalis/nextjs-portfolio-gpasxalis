    ...
    return (
        ...
        >
            <nav className="flex items-center justify-between max-w-6xl mx-auto w-[90%] py-4">
                ...
                >
                    Paschalis Grammenos
                    <span className="text-gp-primary text-3xl -mt-2">.</span>
                </motion.a>
                {/* Nav Links */}
                <motion.div
                    initial={{ opacity: 0, x: -20 }}
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    ...
                    >
                        <div className="bg-black/50 backdrop-blur-lg shadow-gp-accent/10 shadow-lg rounded-2xl mx-4 mt-2 p-6">
                            <div className="flex flex-col gap-4">
                                {navLinks.map((link, index) => (
                                    <motion.a
                                        ...
                                        key={link.hraf || index}
                                        href={link.href}
                                        className="text-gp-accent text-[18px] font-bold hover:text-gp-primary py-3 border-b border-gray-100 transition-all duration-300 ease-in-out"
                                    >
                                        {link.name}
                                    </motion.a>
                                ))}
