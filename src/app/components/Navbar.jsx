...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="sticky top-2 w-full z-50">
                <div className="container flex flex-wrap items-center justify-between mx-auto text-gp-accent border bg-opacity-30 px-5 py-4 backdrop-blur-lg backdrop-filter dark:border-gray-700 rounded-4xl">
                    <Link
                        href="/"
                        className="font-headingFont uppercase mr-4 block cursor-pointer py-1.5 text-gp-primary font-bold text-lg"
                    >
                        Paschalis Grammenos
                    </Link>
                    ...
                    <div className="hidden lg:block">
                        <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                            {navItems.map((item, index) => (
                                <li
                                    key={index}
                                    className="flex items-center p-1 text-lg gap-x-2 text-gp-accent hover:text-gp-primary"
                                >
                                    <Link
                                        href={item.href}
                                        className="flex items-center"
                            ...
                            <li>
                                <ButtonSmall
                                    classes="filled_button"
                                    href_to="https://card.dalution.gr/pgrammenos"
                                    text="My Card"
                                />
                            </li>
                        </ul>
